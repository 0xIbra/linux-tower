...
import { metricTextColorClass, metricBgColorClass, stateTextColorClass, stateBgColorClass } from "@/utils/dynamicClasses";
...
onMounted(async () => {
  ...
  // Chart cpu data
  const cpuData = await metricsStore.getCpuMetricsData();
  const labels = [];
  const cpuValues = [];
  ...
  // Chart memory data
  const memoryData = await metricsStore.getMemoryMetricsData();
  const memoryValues = [];
  for (let i = 0; i < memoryData.length; i++) {
    memoryValues.push(memoryData[i]["value"]);
  }

  // Chart disk data
  const diskData = await metricsStore.getDiskMetricsData();
  const diskValues = [];
  for (let i = 0; i < diskData.length; i++) {
    diskValues.push(diskData[i]["value"]);
  }

  // Init Chart
  const legendState = true;
      ...
      datasets: [
        {
          ...
          borderColor: "#4d60d9",
          pointBorderColor: "#4d60d9",
          pointHoverBackgroundColor: "#4d60d9",
          borderCapStyle: "butt",
          borderDash: [],
        ...
        },
        {
          ...
          backgroundColor: "transparent",
          borderColor: "#4df194",
          pointBorderColor: "#4df194",
          pointHoverBackgroundColor: "#4df194",
          borderCapStyle: "butt",
          borderDash: [],
          borderDashOffset: 0.0,
          borderJoinStyle: "miter",
        ...
        },
        {
          ...
          backgroundColor: "transparent",
          borderColor: "#9f5ae8",
          pointBorderColor: "#9f5ae8",
          pointHoverBackgroundColor: "#9f5ae8",
          borderCapStyle: "butt",
          borderDash: [],
          borderDashOffset: 0.0,
          borderJoinStyle: "miter",
      ...
      <div class="container-fluid">
        <div class="row gy-4">
          <div class="col-md-4 col-sm-3">
            <div v-if="metrics != null" class="cpu-usage-wrapper card mb-0">
              <div class="card-body">
          ...
          <div class="col-md-4 col-sm-3">
            <div v-if="metrics != null" class="card mb-0">
              <div class="card-body">
                <div class="d-flex align-items-end justify-content-between mb-2">
                  <div class="me-2">
          ...
          <div class="col-md-4">
            <div v-if="apacheStore.data != null" class="cpu-usage-wrapper card mb-0">
              <div class="card-body">
                <div class="d-flex align-items-end justify-content-between mb-2">
                  <div class="me-2">
                    <p class="text-sm text-uppercase text-gray-600 lh-1 mb-0">Apache HTTP Server</p>
                  </div>
                  <p class="text-xl lh-1 mb-0" :class="stateTextColorClass(apacheStore.data.details.state)" >{{ apacheStore.data.details.state }}</p>
                </div>
              </div>
            </div>
          </div>
          <div v-if="nginxStore.data != null" class="col-md-4">
            <div class="cpu-usage-wrapper card mb-0">
              <div class="card-body">
                <div class="d-flex align-items-end justify-content-between mb-2">
                  <div class="me-2">
                    <p class="text-sm text-uppercase text-gray-600 lh-1 mb-0">Nginx Server</p>
                  </div>
                  <p class="text-xl lh-1 mb-0" :class="stateTextColorClass(nginxStore.data.details.state)" >{{ nginxStore.data.details.state }}</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div v-if="mysqlStore.data != null" class="cpu-usage-wrapper card mb-0">
              <div class="card-body">
                <div class="d-flex align-items-end justify-content-between mb-2">
                  <div class="me-2">
                    <p class="text-sm text-uppercase text-gray-600 lh-1 mb-0">MySQL Server</p>
                  </div>
                  <p class="text-xl lh-1 mb-0" :class="stateTextColorClass(mysqlStore.data.details.state)" >{{ mysqlStore.data.details.state }}</p>
                </div>
              </div>
            </div>
          </div>
